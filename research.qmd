...
- **A Generalized Tangent Approximation Framework for Strongly Super-Gaussian Likelihoods**  
  ...
  [arXiv preprint](https://doi.org/10.48550/arXiv.2504.05431). Minor revision, JASA (Theory and Methods).  [Code](https://github.com/Roy-SR-007/TAVIE-SSG).
...
- **Probabilistic Symbolic Regression for Equation Discovery via Operator-induced and Regularized Symbolic Forests**  
  Roy, S., **Dey, P.**, Pati, D., Mallick, B.K.  
  [arXiv preprint](https://doi.org/10.48550/arXiv.2509.19710). Submitted. [Code](https://github.com/Roy-SR-007/HierBOSSS).
