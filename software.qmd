...
[GitHub](https://github.com/ProbabilisticSR/VaSST) · [Paper](https://proceedings.mlr.press/v337/roy26a.html)
:::
:::
...
**`Python`** implementation of **HierBOSSS**, a hierarchical Bayesian symbolic regression method using operator-induced and regularized symbolic forests for scientific equation discovery.

[GitHub](https://github.com/ProbabilisticSR/HierBOSSS) · [Preprint](https://doi.org/10.48550/arXiv.2509.19710)
:::
:::
